...
function Records() {
    ...
    // square brackets [] means that this component will only run when the page loads for the first page. If not, it will run every time something happens.
    // [records, error] means to run the function whenever the records or error values changes.
